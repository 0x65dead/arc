...
function decodeParameter(cursor, param, options) {
  ...
  if (param.type === "address")
    return decodeAddress2(cursor, { checksum: checksumAddress });
  if (param.type === "bool")
...
function verify(options) {
  ...
  return secp256k1.verify(options.signature, from(payload), toBytes3(options.publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-IUS5BVCC.js.map
