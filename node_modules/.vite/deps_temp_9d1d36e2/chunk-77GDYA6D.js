...
async function getBlock(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest", includeTransactions: includeTransactions_ } = {}) {
  ...
  const format6 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.block) == null ? void 0 : _c.format) || formatBlock;
  return format6(block, "getBlock");
}
...
async function fillTransaction(client, parameters) {
  ...
  try {
    ...
    const format7 = ((_d = (_c = chain == null ? void 0 : chain.formatters) == null ? void 0 : _c.transaction) == null ? void 0 : _d.format) || formatTransaction;
    const transaction = format7(response.tx);
...
async function getBlockReceipts(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest" } = {}) {
  ...
  if (!receipts)
    throw new BlockNotFoundError({ blockHash, blockNumber });
  const format6 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  return receipts.map((receipt) => format6(receipt, "getBlockReceipts"));
}
...
function hmac256(key, value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = hmac(sha2565, from2(key), from2(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes(bytes);
}
function ripemd1606(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = ripemd1605(from2(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes(bytes);
}
function sha2566(value, options = {}) {
  const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
  const bytes = sha2565(from2(value));
  if (as === "Bytes")
    return bytes;
  return fromBytes(bytes);
}
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b, from15, to2) => bytesToNumberBE(b.slice(from15, to2));
  class Signature {
  ...
  function verify2(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    if (format6 !== void 0 && format6 !== "compact" && format6 !== "der")
      throw new Error("format must be compact or der");
    const isHex2 = typeof sg === "string" || isBytes(sg);
    const isObj = !isHex2 && !format6 && typeof sg === "object" && sg !== null && typeof sg.r === "bigint" && typeof sg.s === "bigint";
    if (!isHex2 && !isObj)
...
function verify(options) {
  ...
  return secp256k12.verify(options.signature, from2(payload), toBytes3(options.publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
async function getTransaction(client, { blockHash, blockNumber, blockTag: blockTag_, hash: hash2, index: index2, sender, nonce }) {
  ...
  const format6 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transaction) == null ? void 0 : _c.format) || formatTransaction;
  return format6(transaction, "getTransaction");
}
...
async function getTransactionReceipt(client, { hash: hash2 }) {
  ...
  const format6 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  return format6(receipt, "getTransactionReceipt");
}
...
async function sendRawTransactionSync(client, { serializedTransaction, throwOnReceiptRevert, timeout }) {
  ...
  const format6 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  const formatted = format6(receipt);
...
async function signTransaction(client, parameters) {
  ...
  const format6 = ((_b = formatters == null ? void 0 : formatters.transactionRequest) == null ? void 0 : _b.format) || formatTransactionRequest;
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-77GDYA6D.js.map
